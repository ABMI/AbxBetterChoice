...
OhdsiRTools::checkUsagePackage("SimpleABCceftriaxone")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/SimpleABCceftriaxone.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SimpleABCceftriaxone.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("SimpleABCceftriaxone")

library(SimpleABCceftriaxone)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./SimpleABCceftriaxoneResults"
...
cohortTable <- 'SimpleABCceftriaxoneCohort'
#=======================
...
SimpleABCceftriaxone::runCohortDiagnostics(connectionDetails = connectionDetails,

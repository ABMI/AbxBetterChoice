...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "SimpleABCceftriaxone",
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "SimpleABCceftriaxone")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "SimpleABCceftriaxone")

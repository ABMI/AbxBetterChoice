library(SimpleABCtetracycline)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./SimpleABCtetracyclineResults"
...
cohortTable <- 'SimpleABCtetracyclineCohort'
#=======================
...
SimpleABCtetracycline::runCohortDiagnostics(connectionDetails = connectionDetails,

...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "SimpleABCtetracycline",
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "SimpleABCtetracycline")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "SimpleABCtetracycline")

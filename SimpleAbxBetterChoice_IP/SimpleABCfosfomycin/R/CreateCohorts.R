...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "SimpleABCfosfomycin",
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "SimpleABCfosfomycin")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "SimpleABCfosfomycin")

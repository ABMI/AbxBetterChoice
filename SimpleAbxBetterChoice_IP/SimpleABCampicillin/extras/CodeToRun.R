library(SimpleABCampicillin)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./SimpleABCampicillinResults"
...
cohortTable <- 'SimpleABCampicillinCohort'
#=======================
...
SimpleABCampicillin::runCohortDiagnostics(connectionDetails = connectionDetails,

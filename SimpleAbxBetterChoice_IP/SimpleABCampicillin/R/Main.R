...
#'
#' @details
#' This function executes the SimpleABCampicillin Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if (createCohorts) {
    ...
    SimpleABCampicillin::createCohorts(connectionDetails = connectionDetails,
  ...
  if(runAnalyses){
    ...
    if(!is.null(cohortVariableSetting)){
      ...
      pathToCustom <- system.file("settings", paste0(cohortVariableSetting, ".csv"), package = "SimpleABCampicillin")
    ...
    if(!is.null(calculatedVariableSetting)){
  ...
  if (createShiny) {
    SimpleABCampicillin::populateShinyApp(outputDirectory = file.path(outputFolder, 'ShinyApp'),

library(SimpleABCgentamicin)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./SimpleABCgentamicinResults"
...
cohortTable <- 'SimpleABCgentamicinCohort'
#=======================
...
SimpleABCgentamicin::runCohortDiagnostics(connectionDetails = connectionDetails,

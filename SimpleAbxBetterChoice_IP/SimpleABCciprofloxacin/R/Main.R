...
#
# This file is part of SimpleABCciprofloxacin
#
...
#'
#' @details
#' This function executes the SimpleABCciprofloxacin Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if (createCohorts) {
    ...
    SimpleABCciprofloxacin::createCohorts(connectionDetails = connectionDetails,
  ...
  if(runAnalyses){
    ...
    predictionAnalysisListFile <- system.file("settings",
                                              ...
                                              package = "SimpleABCciprofloxacin")
    ...
    if(!is.null(cohortVariableSetting)){
      ...
      pathToCustom <- system.file("settings", paste0(cohortVariableSetting, ".csv"), package = "SimpleABCciprofloxacin")
      ...
      for(i in 1:nrow(cohortVarsToCreate)){
        cohortCov[[1+i]] <- SimpleABCciprofloxacin::createCohortCovariateSettings(covariateName = as.character(cohortVarsToCreate$cohortName[i]),
  ...
  if (createShiny) {
    SimpleABCciprofloxacin::populateShinyApp(outputDirectory = file.path(outputFolder, 'ShinyApp'),

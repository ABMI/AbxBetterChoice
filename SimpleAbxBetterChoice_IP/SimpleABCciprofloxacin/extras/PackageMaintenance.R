...
OhdsiRTools::checkUsagePackage("ABCciprofloxacin")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ABCciprofloxacin.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ABCciprofloxacin.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ABCciprofloxacin")

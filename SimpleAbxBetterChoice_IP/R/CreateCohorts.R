...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "SimpleAbxBetterChoice",
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "SimpleAbxBetterChoice")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "SimpleAbxBetterChoice")
  ...
  if(!is.null(cohortVariableSetting)){
    ...
    pathToCustom <- system.file("settings", paste0(cohortVariableSetting,'.csv'), package = "SimpleAbxBetterChoice")

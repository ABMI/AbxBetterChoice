...
devtools::install(file.path(getwd(), "SimpleABCceftriaxone"))
devtools::install(file.path(getwd(), "SimpleABCciprofloxacin"))
devtools::install(file.path(getwd(), "SimpleABCtmpsmx"))
devtools::install(file.path(getwd(), "SimpleABClevofloxacin"))
devtools::install(file.path(getwd(), "SimpleABCnitrofurantoin"))
devtools::install(file.path(getwd(), "SimpleABCtetracycline"))
devtools::install(file.path(getwd(), "SimpleABCgentamicin"))
devtools::install(file.path(getwd(), "SimpleABCampicillin"))
devtools::install(getwd())

# Load the package
library(SimpleAbxBetterChoice)

path <- 's:/AbxBetterChoice'
...
outputFolder <- "s:/AbxBetterChoice/ccae"

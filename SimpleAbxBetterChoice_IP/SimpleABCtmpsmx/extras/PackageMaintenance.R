...
OhdsiRTools::checkUsagePackage("SimpleABCtmpsmx")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/SimpleABCtmpsmx.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SimpleABCtmpsmx.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("SimpleABCtmpsmx")

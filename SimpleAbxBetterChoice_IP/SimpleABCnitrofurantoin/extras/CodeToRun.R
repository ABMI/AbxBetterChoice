library(SimpleABCnitrofurantoin)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./SimpleABCnitrofurantoinResults"
...
cohortTable <- 'SimpleABCnitrofurantoinCohort'
#=======================
...
SimpleABCnitrofurantoin::runCohortDiagnostics(connectionDetails = connectionDetails,

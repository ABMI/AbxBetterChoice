...
OhdsiRTools::checkUsagePackage("SimpleABCnitrofurantoin")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/SimpleABCnitrofurantoin.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SimpleABCnitrofurantoin.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "SimpleABCnitrofurantoin")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("SimpleABCnitrofurantoin")

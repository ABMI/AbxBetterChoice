library(SimpleABClevofloxacin)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./SimpleABClevofloxacinResults"
...
cohortTable <- 'SimpleABClevofloxacinCohort'
#=======================
...
SimpleABClevofloxacin::runCohortDiagnostics(connectionDetails = connectionDetails,

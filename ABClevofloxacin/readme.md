A Package for Antibiotics for the Better Choice - levofloxacin model
========================================================

A skeleton package, to be used as a starting point when implementing patient-level prediction studies.

Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/ABClevofloxacin/inst/doc/UsingSkeletonPackage.pdf)
...
cohortTable <- 'ABClevofloxacinCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/ABClevofloxacin")
```

library(ABCgentamicin)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./ABCgentamicinResults"
...
cohortTable <- 'ABCgentamicinCohort'
#=======================
...
ABCgentamicin::runCohortDiagnostics(connectionDetails = connectionDetails,

library(ABCampicillin)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./ABCampicillinResults"
...
cohortTable <- 'ABCampicillinCohort'
#=======================
...
ABCampicillin::runCohortDiagnostics(connectionDetails = connectionDetails,

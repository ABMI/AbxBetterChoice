...
#
# This file is part of ABCnitrofurantoin
#
...
#'
#' @details
#' This function executes the ABCnitrofurantoin Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if (createCohorts) {
    ...
    ABCnitrofurantoin::createCohorts(connectionDetails = connectionDetails,
  ...
  if(runAnalyses){
    ...
    if(!is.null(cohortVariableSetting)){
      ...
      pathToCustom <- system.file("settings", paste0(cohortVariableSetting, ".csv"), package = "ABCnitrofurantoin")
  ...
  if (createShiny) {
    ABCnitrofurantoin::populateShinyApp(outputDirectory = file.path(outputFolder, 'ShinyApp'),

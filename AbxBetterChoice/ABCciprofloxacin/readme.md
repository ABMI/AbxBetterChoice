A Package for Antibiotics Better Choice - ciprofloxacin model
========================================================

A skeleton package, to be used as a starting point when implementing patient-level prediction studies.

Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/ABCciprofloxacin/inst/doc/UsingSkeletonPackage.pdf)
...
cohortTable <- 'ABCciprofloxacinCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/ABCciprofloxacin")
```

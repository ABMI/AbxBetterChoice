library(ABCtetracycline)
# USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./ABCtetracyclineResults"
...
cohortTable <- 'ABCtetracyclineCohort'
#=======================
...
ABCtetracycline::runCohortDiagnostics(connectionDetails = connectionDetails,

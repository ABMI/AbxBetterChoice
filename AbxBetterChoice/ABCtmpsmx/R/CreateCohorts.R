...
#
# This file is part of ABCtmpsmx
#
...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "ABCtmpsmx")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "ABCtmpsmx")
  ...
  if(!is.null(cohortVariableSetting)){
    ...
    pathToCustom <- system.file("settings", paste0(cohortVariableSetting,'.csv'), package = "ABCtmpsmx")

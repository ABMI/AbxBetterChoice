...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/evidnet/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/evidnet")
```

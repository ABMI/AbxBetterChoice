...
OhdsiRTools::checkUsagePackage("ABCgentamicin")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ABCgentamicin.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ABCgentamicin.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ABCgentamicin")

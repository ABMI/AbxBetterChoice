...
OhdsiRTools::checkUsagePackage("ABCceftriaxone")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ABCceftriaxone.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ABCceftriaxone.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ABCceftriaxone")

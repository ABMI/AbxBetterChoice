...
OhdsiRTools::checkUsagePackage("ABCampicillin")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ABCampicillin.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ABCampicillin.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ABCampicillin")
